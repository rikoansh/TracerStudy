  ...
  <body>
    ...
    <div id="navmain" class="col-md-12 navmain-left collapse navbar-collapse">
        <ul class="nav navbar-nav navbar-left">
          ...
          @else
          <li><a href="{{ route('dekan::homeRektor')}}">Home</a></li>
          <li><a href="{{ route('dekan::tracerstudy') }}">Hasil Tracer Study</a></li>
          <li><a href="{{ route('dekan::laporan') }}">Laporan</a></li>
          <li><a href="{{ route('dekan::setting')}}">Setting Profile</a></li>
