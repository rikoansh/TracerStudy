  ...
  <body>
    ...
    <div id="navmain" class="col-md-12 navmain-left collapse navbar-collapse">
        <ul class="nav navbar-nav navbar-left">
          ...
          @else
          <li><a href="{{ route('rektor::homeRektor')}}">Home</a></li>
          <li><a href="{{ route('rektor::tracerstudy') }}">Hasil Tracer Study</a></li>
          <li><a href="{{ route('rektor::laporan') }}">Laporan</a></li>
          <li><a href="{{ route('rektor::setting')}}">Setting Profile</a></li>
