...
<div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            ...
                            @endif
                    <form role="form" method="POST" action="{{ route('akademik::simpan_laporan')}}" accept-charset="UTF-8" enctype ="multipart/form-data">
                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                        ...
                                        <div class="form-group">
                                            <label>Isi</label>
                                            <textarea name="isi" value="{{ old('isi') }}">Masukan isi laporan</textarea>
                                        </div>
